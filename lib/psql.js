...
const cn = {
  ...
  database: 'cbpbgvhd',
  user: 'cbpbgvhd',
  password: 'AkSpxn8vBYDIgdgXtBxLUF1ge4d8y8jw',
};
const db = pgp(cn);
...
module.exports = {
  ...
  getSightings: (birdId, locId) =>
    db.any('SELECT * FROM birds_location WHERE id_loc = $1 AND id_bird = $2', [locId, birdId]),
  ...
  getLastSeenFlock: (birdId, userLocID) =>
    db.any('SELECT recent_group_size, last_seen FROM WHERE id_bird = $1 AND id_user_loc = $2', [birdId, userLocID]),
  ...
  storeFirstSeen: (birdId, locId, firstSeen, rarity) =>
    db.any('INSERT INTO birds_location (id_loc, id_bird, first_seen, rarity, sightings) VALUES ($1, $2, $3, $4, $5)', [locId, birdId, firstSeen, rarity, 1]),
  ...
  updateSightingsAndRarity: (birdId, locId, rarity) =>
    db.any('UPDATE birds_location SET sightings = sightings + 1, rarity = $3 WHERE id_loc = $1 AND id_bird = $2', [locId, birdId, rarity]),
