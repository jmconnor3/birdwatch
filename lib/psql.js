...
module.exports = {
  ...
  storeFirstSeen: (birdId, locId, firstSeen) =>
    db.any('INERT INTO birds_location (id_loc, id_bird, first_seen) VALUES ($1, $2, $3)', [locId, birdId, firstSeen]),
  ...
  addToChecklist: (birdId, userLocID, lastSeen, flockSize) =>
    db.any('INSERT INTO birds_users_locs (id_bird, id_user_loc, last_seen, recent_group_size), ', [birdId, userLocID, lastSeen, flockSize]),
